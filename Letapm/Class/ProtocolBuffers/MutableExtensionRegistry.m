...
@interface BatPBMutableExtensionRegistry()
@property (retain) NSMutableDictionary* mutableClassMap;
@end

@implementation BatPBMutableExtensionRegistry
...
+ (BatPBMutableExtensionRegistry*) registry {
  return [[[BatPBMutableExtensionRegistry alloc] initWithClassMap:[NSMutableDictionary dictionary]] autorelease];
}
