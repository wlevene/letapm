...
@interface BatPBConcreteExtensionField()
...
@implementation BatPBConcreteExtensionField
...
+ (BatPBConcreteExtensionField*) extensionWithType:(PBExtensionType) type
  ...
  return [[[BatPBConcreteExtensionField alloc] initWithType:type
...
- (void)           writeSingleValue:(id) value
    includingTagToCodedOutputStream:(BatPBCodedOutputStream*) output {
  switch (type) {
    case PBExtensionTypeBool:
...
- (void)           writeSingleValue:(id) value
    noTagToCodedOutputStream:(BatPBCodedOutputStream*) output {
  switch (type) {
    case PBExtensionTypeBool:
...
- (void) writeDescriptionOfSingleValue:(id) value
  ...
  switch (type) {
    ...
    case PBExtensionTypeGroup:
    case PBExtensionTypeMessage:
      [((BatPBAbstractMessage *)value) writeDescriptionTo:output withIndent:indent];
      return;
  }
  @throw [NSException exceptionWithName:@"InternalError" reason:@"" userInfo:nil];
}
...
- (void)         writeRepeatedValues:(NSArray*) values
    includingTagsToCodedOutputStream:(BatPBCodedOutputStream*) output {
  if (isPacked) {
...
- (void) mergeMessageSetExtentionFromCodedInputStream:(BatPBCodedInputStream*) input
...
- (id) readSingleValueFromCodedInputStream:(BatPBCodedInputStream*) input
  ...
  switch (type) {
    ...
    case PBExtensionTypeGroup:
    {
      id<BatPBMessage_Builder> builder = [messageOrGroupClass builder];
