...
@implementation BatPBExtendableMessage_Builder
...
- (BOOL) parseUnknownField:(BatPBCodedInputStream*) input
         ...
         extensionRegistry:(BatPBExtensionRegistry*) extensionRegistry
                       tag:(int32_t) tag {
  BatPBExtendableMessage* message = [self internalGetResult];
...
- (BatPBExtendableMessage_Builder*) setExtension:(id<PBExtensionField>) extension
                                        value:(id) value {
  BatPBExtendableMessage* message = [self internalGetResult];
...
- (BatPBExtendableMessage_Builder*) addExtension:(id<PBExtensionField>) extension
                                        value:(id) value {
  BatPBExtendableMessage* message = [self internalGetResult];
  [message ensureExtensionIsRegistered:extension];
...
- (BatPBExtendableMessage_Builder*) clearExtension:(id<PBExtensionField>) extension {
  BatPBExtendableMessage* message = [self internalGetResult];
  [message ensureExtensionIsRegistered:extension];
...
- (void) mergeExtensionFields:(BatPBExtendableMessage*) other {
  BatPBExtendableMessage* thisMessage = [self internalGetResult];
