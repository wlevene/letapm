...
@interface BatPBCodedInputStream : NSObject {
@private
...
+ (BatPBCodedInputStream*) streamWithData:(NSData*) data;
+ (BatPBCodedInputStream*) streamWithInputStream:(NSInputStream*) input;
...
- (void) readMessage:(id<BatPBMessage_Builder>) builder extensionRegistry:(BatPBExtensionRegistry*) extensionRegistry;

- (BOOL) readBool;
- (NSString*) readString;
- (NSData*) readData;

- (void) readGroup:(int32_t) fieldNumber builder:(id<BatPBMessage_Builder>) builder extensionRegistry:(BatPBExtensionRegistry*) extensionRegistry;

/**
 * Reads a {@code group} field value from the stream and merges it into the
 * given {@link UnknownFieldSet}.
 */
- (void) readUnknownGroup:(int32_t) fieldNumber builder:(BatPBUnknownFieldSet_Builder*) builder;
