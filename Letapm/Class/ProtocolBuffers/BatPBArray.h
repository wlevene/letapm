...
@interface BatPBArray : NSObject <NSCopying, NSFastEnumeration>
{
@protected
...
@interface BatPBArray (PBArrayExtended)

- (id)arrayByAppendingArray:(BatPBArray *)array;

@end

@interface BatPBArray (PBArrayCreation)
...
@interface BatPBAppendableArray : BatPBArray
