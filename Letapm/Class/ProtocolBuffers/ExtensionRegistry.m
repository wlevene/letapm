...
@interface BatPBExtensionRegistry()
@property (retain) NSDictionary* classMap;
@end

@implementation BatPBExtensionRegistry
...
static BatPBExtensionRegistry* emptyRegistry = nil;

+ (void) initialize {
  if (self == [BatPBExtensionRegistry class]) {
    emptyRegistry = [[BatPBExtensionRegistry alloc] initWithClassMap:[NSDictionary dictionary]];
  }
}
...
+ (BatPBExtensionRegistry*) emptyRegistry {
