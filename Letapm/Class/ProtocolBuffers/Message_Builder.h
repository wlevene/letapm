 ...
 */
@protocol BatPBMessage_Builder<NSObject>
 ...
 */
- (id<BatPBMessage_Builder>) mergeFromCodedInputStream:(BatPBCodedInputStream*) input extensionRegistry:(BatPBExtensionRegistry*) extensionRegistry;
 ...
 */
- (id<BatPBMessage_Builder>) mergeFromData:(NSData*) data extensionRegistry:(BatPBExtensionRegistry*) extensionRegistry;
 ...
 * {@link #mergeFrom(CodedInputStream,ExtensionRegistry)}.
 */
- (id<BatPBMessage_Builder>) mergeFromInputStream:(NSInputStream*) input extensionRegistry:(BatPBExtensionRegistry*) extensionRegistry;
