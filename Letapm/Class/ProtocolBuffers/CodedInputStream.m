...
@interface BatPBCodedInputStream ()
@property (retain) NSMutableData* buffer;
@property (retain) NSInputStream* input;
@end


@implementation BatPBCodedInputStream
...
+ (BatPBCodedInputStream*) streamWithData:(NSData*) data {
  return [[[BatPBCodedInputStream alloc] initWithData:data] autorelease];
}


+ (BatPBCodedInputStream*) streamWithInputStream:(NSInputStream*) input {
  return [[[BatPBCodedInputStream alloc] initWithInputStream:input] autorelease];
}
...
- (void)      readGroup:(int32_t) fieldNumber
                builder:(id<BatPBMessage_Builder>) builder
...
- (void) readUnknownGroup:(int32_t) fieldNumber
                  builder:(BatPBUnknownFieldSet_Builder*) builder {
  if (recursionDepth >= recursionLimit) {
    @throw [NSException exceptionWithName:@"InvalidProtocolBuffer" reason:@"Recursion Limit Exceeded" userInfo:nil];
  }
  ++recursionDepth;
...
- (void) readMessage:(id<BatPBMessage_Builder>) builder
   extensionRegistry:(BatPBExtensionRegistry*) extensionRegistry {
