 ...
 */
int32_t computeGroupSize(int32_t fieldNumber, const id<BatPBMessage> value);
 ...
 * tag.
 */
int32_t computeUnknownGroupSize(int32_t fieldNumber, const BatPBUnknownFieldSet* value);

/**
 * Compute the number of bytes that would be needed to encode an
 * embedded message field, including tag.
 */
int32_t computeMessageSize(int32_t fieldNumber, const id<BatPBMessage> value);
 ...
 * {@code group} field, including tag.
 */
int32_t computeGroupSizeNoTag(const id<BatPBMessage> value);
 ...
 * tag.
 */
int32_t computeUnknownGroupSizeNoTag(const BatPBUnknownFieldSet* value);

/**
 * Compute the number of bytes that would be needed to encode an
 * embedded message field, including tag.
 */
int32_t computeMessageSizeNoTag(const id<BatPBMessage> value);
 ...
 */
int32_t computeMessageSetExtensionSize(int32_t fieldNumber, const id<BatPBMessage> value);
