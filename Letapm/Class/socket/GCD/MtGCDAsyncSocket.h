...
@class MtGCDAsyncReadPacket;
@class MtGCDAsyncWritePacket;
@class MtGCDAsyncSocketPreBuffer;

extern NSString *const MtGCDAsyncSocketException;
extern NSString *const MtGCDAsyncSocketErrorDomain;

extern NSString *const MtGCDAsyncSocketQueueName;
extern NSString *const MtGCDAsyncSocketThreadName;

extern NSString *const MtGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const MtGCDAsyncSocketUseCFStreamForTLS;
#endif
#define MtGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define MtGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define MtGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const MtGCDAsyncSocketSSLPeerID;
extern NSString *const MtGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const MtGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const MtGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const MtGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const MtGCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const MtGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define MtGCDAsyncSocketLoggingContext 65535


typedef NS_ENUM(NSInteger, MtGCDAsyncSocketError) {
	MtGCDAsyncSocketNoError = 0,           // Never used
	MtGCDAsyncSocketBadConfigError,        // Invalid configuration
	MtGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	MtGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	MtGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	MtGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	MtGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	MtGCDAsyncSocketClosedError,           // The remote peer closed the connection
	MtGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface MtGCDAsyncSocket : NSObject
 ...
 * it is treated similarly to a timeout - the socket is closed with a MtGCDAsyncSocketReadMaxedOutError.
 ...
 *
 * - MtGCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
...
@protocol MtGCDAsyncSocketDelegate
@optional
...
**/
- (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(MtGCDAsyncSocket *)sock;
...
**/
- (void)socket:(MtGCDAsyncSocket *)sock didAcceptNewSocket:(MtGCDAsyncSocket *)newSocket;

/**
 * Called when a socket connects and is ready for reading and writing.
 * The host parameter will be an IP address, not a DNS name.
**/
- (void)socket:(MtGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port;

/**
 * Called when a socket connects and is ready for reading and writing.
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(MtGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (void)socket:(MtGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(MtGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(MtGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(MtGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(MtGCDAsyncSocket *)sock;
...
**/
- (void)socketDidSecure:(MtGCDAsyncSocket *)sock;
...
**/
- (void)socket:(MtGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
