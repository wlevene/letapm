...
@implementation NSObject (MtJRSwizzle)

+ (BOOL)mtjr_swizzleMethod:(SEL)origSel_ withMethod:(SEL)altSel_ error:(NSError**)error_ {
#if OBJC_API_VERSION >= 2
...
+ (BOOL)mtjr_swizzleClassMethod:(SEL)origSel_ withClassMethod:(SEL)altSel_ error:(NSError**)error_ {
	return [GetClass((id)self) mtjr_swizzleMethod:origSel_ withMethod:altSel_ error:error_];
}
